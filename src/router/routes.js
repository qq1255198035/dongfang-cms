...
import Data from '../views/MyData/Data';
import UnionData from '../views/MyData/UnionData';
import PointsData from '../views/points/PointsData';
export const routes = [
	{ path: '/dashboard', component: Dashboard },
	{ path: '/add/:id?', component: AddItem },
	{ path: '/data/:id?', component: Data },
	{ path: '/uniondata', component: UnionData },
	{ path: '/points/:id?', component: PointsData },
